...
//this is used to wrap the text inside node
            ...
            if(nodeArray[node]["hide"] == undefined){
				...
				// }else{
					...
					//if(nodeArray[node].lane == "Approve_PO"){
						...
						v1 = graph.insertVertex(graph.getModel().cells[configLanes[nodeArray[node].lane]], nodeArray[node].name, wordwrap(vertexName,30), globalX*t_width*1.5, depth*t_height*2, v_width, v_height,nodeStyle+vertexStyle);					
					//}else{
